      ...
      {isVisible && (
        <div className="fixed right-6 bottom-6 z-40 flex flex-col gap-3">
          ...
          <motion.button
            ...
            className="group relative bg-emerald-600 text-white p-4 rounded-full shadow-lg hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:scale-110 transition-all duration-300 border border-emerald-500"
            aria-label="Contact Me"
          >
            <FaEnvelope className="text-xl" />
            <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-slate-900 dark:bg-slate-100 text-emerald-400 dark:text-emerald-700 px-3 py-1 rounded-sm text-sm font-mono whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none border border-emerald-500">
              OPEN_COMMS
            </span>
          </motion.button>
